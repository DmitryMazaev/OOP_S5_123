...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        HashMap<Long, Student> hashMapStudent = new HashMap<Long, Student>();
        hashMapStudent.put(l7, s7);
        hashMapStudent.put(l8, s8);
        hashMapStudent.put(l9, s9);
        hashMapStudent.put(l10, s10);
        hashMapStudent.put(l11, s11);
        hashMapStudent.put(l12, s12);
        ...
        Controller controllerHashMap = new Controller(hashMapStudent, view); // Дописать контроллер!!!
